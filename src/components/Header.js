      ...
      <header id='header'>
          <div id='header-inner'>
            ...
            <div className='smp'>
              ...
              <ul className='h_tool'>
                <li><a href="tel:0120-781-437"><img src='/images/h_tel.png' loading="lazy" alt='' /></a></li>
                ...
                <div className="smp_nav_cont">
                  <div className="smp_nav_box koushin">
                    <Link to="/hpkoushin/" className="flex-wrap">
                      <div className='smp_nav_img'><StaticImage src='../images/service_img01.png' loading="lazy" alt="ホームページ修正・更新サポート" /></div>
                      <div className='smp_nav_txt'>ホームページ修正・更新サポート</div>
                    </Link>
                  </div>
                  <div className="smp_nav_box responsive">
                    <Link to="/responsive/" className="flex-wrap">
                      <div className='smp_nav_img'><StaticImage src='../images/service_img02.png' loading="lazy" alt="スマホ対応・レスポンシブ化" /></div>
                      <div className='smp_nav_txt'>スマホ対応・レスポンシブ化</div>
                    </Link>
                  </div>
                  <div className="smp_nav_box seo">
                    <Link to="/region-seo/" className="flex-wrap">
                      <div className='smp_nav_img'><StaticImage src='../images/service_img03.png' loading="lazy" alt="SEO対策" /></div>
