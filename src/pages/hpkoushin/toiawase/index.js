          ...
          <table className='form'>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <input type='text' name='ご担当者名' size={30} required='required' />
                </td>
              </tr>
              <tr>
                <th>
                ...
                <td>
                  <input type='tel' data-type='tel' name='電話番号' size={16} />
                </td>
              </tr>
              <tr>
                <th>
              ...
              <tr>
                <th>ホームページURL</th>
                <td>
                  <input type='url' name='ホームページURL' size={30} placeholder='https://example.com' />
                </td>
              </tr>
              <tr>
                <th>メッセージ</th>
                <td>
                  <textarea name='メッセージ' rows={10} cols={60} defaultValue={''} />
                </td>
              </tr>
            </tbody>
          </table>
...
export default HpkoushinToiawase;
