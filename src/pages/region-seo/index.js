...
export default function index() {
  return (
    ...
    <Layout>
        ...
        <ul className="list02">
            <li><FontAwesomeIcon icon={faCheck} />Googleの検索順位を月に1回レポートします。</li>
            <li><FontAwesomeIcon icon={faCheck} />状況に応じてサイト構造の変更を行います。</li>
            ...
            <li><FontAwesomeIcon icon={faCheck} />月額費用は最初の3ヶ月間は必須です。それ以降は月ごとの自動更新。</li>
        ...
        <p className="center"><Link to="/region-seo/seo-form/"><img src="/images/seo_bt.png" alt="メールでのお申し込みはこちら" width={760} height={114} /></Link></p>
