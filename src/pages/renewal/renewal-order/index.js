...
export default function index() {
  return (
    ...
    <tbody>
        <tr>
        <th>作成プラン<span className="must">必須</span></th>
        <td>
          <label><input type="radio" name="作成プラン" defaultChecked="checked" defaultValue="基本リニューアルプラン" required="required" />基本リニューアルプラン</label>
        </td>
      </tr>
      <tr>
        <th>作成オプション</th>
        <td>
          <label><input type="checkbox" name="作成オプション" defaultValue="CMS対応プラン" />CMS対応プラン</label>
        </td>
      </tr>
      <tr>
        <th>サポートプラン<span className="must">必須</span></th>
        <td>
          <label><input type="radio" name="サポートプラン" defaultValue="ライトプラン" defaultChecked="checked" required="required" />ライトプラン</label>
          <label><input type="radio" name="サポートプラン" defaultValue="スタンダードプラン" required="required" />スタンダードプラン</label>
          <label><input type="radio" name="サポートプラン" defaultValue="サポートなし" required="required" />サポートなし</label>
        </td>
      </tr>
      <tr>
