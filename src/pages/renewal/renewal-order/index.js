        ...
        <form action='https://ssgform.com/s/b43Yvx8zUuIK' method='post'>
          ...
          <table className='form'>
            <tbody>
              ...
              <tr>
                <th>
                  フリガナ<span className='must'>必須</span>
                </th>
                <td>
              ...
              <tr>
                <th>
                  確認のためもう一度<span className='must'>必須</span>
                </th>
                <td>
              ...
              <tr>
                <th>
                  郵便番号<span className='must'>必須</span>
                </th>
                <td>
                  <input type='text' name='郵便番号' size={30} required='required' />
                </td>
              </tr>
              <tr>
                <th>
                  ご住所<span className='must'>必須</span>
                </th>
                <td>
                  <ol style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                    ...
                    <li>
                      <span>市区町村</span> <input type='text' name='市区町村' size={50} required='required' />
                    </li>
                    <li>
                      <span>丁目番地</span> <input type='text' name='丁目番地' size={50} required='required' />
                    </li>
                  </ol>
                </td>
              </tr>
              <tr>
                <th>
                  電話番号<span className='must'>必須</span>
                </th>
                <td>
                  <input type='tel' data-type='tel' name='電話番号' size={30} data-min={9} required='required' />
                </td>
              </tr>
              <tr>
                <th>URL</th>
                <td>
                  <input type='url' data-type='url' name='URL' size={60} />
                </td>
              </tr>
              <tr>
                <th>メッセージ</th>
                <td>
                  <textarea name='メッセージ' rows={10} cols={10} defaultValue={''} />
                </td>
              </tr>
            </tbody>
          </table>
...
export default RenewalOrderIndex;
