    ...
    <>
        ...
        <div id="breadcrumb">
            ...
            <li className="breadcrumb__item" itemProp="itemListElement" itemType="https://schema.org/ListItem">
                ...
                <li>
                    <a href="https://www.blanc.to/renewal/renewal-order/" itemprop="item">
        ...
        <Layout>
            ...
            <p className="center">「ホームページリニューアル」お申し込み確認メールを送信しました。<br />
            ...
            <p className="center"><a href="/renewal/"><span className="bt02">元のページに戻る</span></a></p>
