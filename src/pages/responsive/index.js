        ...
        <div className='maincontent'>
            ...
            <section id='subpage'>
                <div className='main-content'>
                    ...
                    <a href="https://www.google.com/webmasters/tools/mobile-friendly/" target="_blank" rel="noopener noreferrer"><span class ="bt_link">モバイルフレンドリーテスト</span></a></p>
                    <p>このテストを利用することで、ユーザーがスマートフォンやタブレットでページにアクセスした際の体験を向上させるための具体的な提案や指示を得ることができます。<br />
                    使用方法は非常にシンプルです。テストしたいウェブページのURLを入力し、評価を開始するだけ。数分以内に結果が表示され、ページがモバイルフレンドリーであるか、あるいは改善点や問題点がある場合はそれらの詳細を確認することができます。</p>
