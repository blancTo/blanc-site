  ...
  return (
    <>
      ...
      <Layout>
        ...
        <form action='https://ssgform.com/s/JL3on4tV5K3O' method='post'>
          ...
          <table className='form'>
            <tbody>
              ...
              <tr>
                <th>
                  URL<span className='must'>必須</span>
                </th>
                <td>
                  <input type='url' data-type='url' name='URL' size={60} required='required' />
                </td>
              </tr>
              <tr>
                <th>
                  ご利用のサーバー<span className='must'>必須</span>
                </th>
                <td>
                  <input type='text' name='ご利用のサーバー' size={60} required='required' />
                </td>
              </tr>
              <tr>
                <th>メッセージ</th>
