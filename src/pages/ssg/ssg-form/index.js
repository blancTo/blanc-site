    ...
    <>
      ...
      <div id='breadcrumb'>
        <ul itemType='https://schema.org/BreadcrumbList'>
          ...
          <li>
            <Link to='https://www.blanc.to/ssg/' itemprop='item'>
        ...
        <form action='https://ssgform.com/s/u7hKBINWAn7B' method='post'>
          ...
          <table className='form'>
            <tbody>
              <tr>
                <th>
                  会社名<span className='must'>必須</span>
                </th>
                <td>
                  <input type='text' name='会社名' size={45} required='required' />
                </td>
              </tr>
              <tr>
                <th>
                  ご担当者名<span className='must'>必須</span>
                </th>
                <td>
                  <input type='text' name='ご担当者名' size={45} required='required' />
                </td>
              </tr>
              <tr>
                <th>
              ...
              <tr>
                <th>
                  ホームページURL<span className='must'>必須</span>
                </th>
                <td>
                  <input type='url' data-type='url' name='ホームページURL' size={60} required='required' />
                </td>
              </tr>
              <tr>
                <th>備考</th>
                <td>
                  <textarea name='備考' rows={10} cols={10} defaultValue={''} />
                </td>
              </tr>
            </tbody>
          </table>
